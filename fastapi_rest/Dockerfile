...
COPY fastapi_rest.py .
EXPOSE 8000

# Enhanced python options for unbuffered run (for print() to output immediatelly)
CMD ["python", "-u", "-m", "uvicorn", "fastapi_rest:app", "--host", "0.0.0.0", "--port", "8000"]
